...
<context>
    ...
    <message>
        ...
        <translation>ownKeepass是一个与Keepass 1.x兼容的密码安全应用</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;b&gt;开发组&lt;/b&gt;&lt;br&gt;&lt;br&gt;Jolla（在诺基亚停止后继续开发）&lt;br&gt;KeepassX项目（Keepass的Qt实现）&lt;br&gt;Petri Mäkijärvi（芬兰语翻译和测试）&lt;br&gt;Åke Engelbrektson （瑞典语翻译）&lt;br&gt;Agusti Clara（加泰罗尼亚语翻译）&lt;br&gt;fri（捷克语翻译）&lt;br&gt;Heimen Stoffels, Rob K, Nathan Follens（德语翻译）&lt;br&gt;carmenfdezb（西班牙语翻译）&lt;br&gt;&lt;br&gt;&lt;br&gt;&lt;a href=&quot;https://github.com/jobe-m/ownkeepass&quot;&gt;https://github.com/jobe-m/ownkeepass&lt;/a&gt;&lt;br&gt;&lt;br&gt;希望你在使用ownKeepass时跟我在创造它时一样快乐！</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>开启后，只需输入主密码最后三位即可快速解锁数据库</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>在本页上你可以创建一个新数据库，以让ownKeepass存储你的敏感数据。&lt;br&gt;&lt;br&gt;打开文件浏览器并选择一个文件名和目录。你可以选择将你的数据库存储在主目录，SD卡或者安卓存储中。如果SD卡选项为灰色，说明没有SD卡或者SD卡被系统保护。SD卡只能有一个分区。目前ownKeepass不支持多分区SD卡。“安卓存储”用来和安卓应用共享数据库。但是，因为所有者和权限不同，和安卓共享文件可能会出现问题，请注意这点。&lt;br&gt;&lt;br&gt;建议：如果你将Keepass数据库上传到云中，请确认除了主密码外你使用的是一个本地存储的关键字文件。这个关键字文件不应该被上传到云服务中。&lt;br&gt;&lt;br&gt;&lt;b&gt;使用关键字文件&lt;/b&gt;&lt;br&gt;&lt;br&gt;一个关键字文件可以被用来存储主密码以保护Keepass数据库。两者都被一起用来生成通行金钥以打开数据库。因此，通过使用一个含有大量生成的通行金匙可以在原则上更强大地防范攻击。你可以使用例如一个随机的图片文件来作为关键字文件。&lt;br&gt;&lt;br&gt;&lt;b&gt;主密码&lt;/b&gt;&lt;br&gt;&lt;br&gt;这是你新Keepass数据库的密码。请确保你使用了大约10-15字符的长密码并混合了小写、大写、数字和特殊符号。在“确认密码”输入框中再次输入密码。&lt;br&gt;&lt;br&gt;&lt;b&gt;自动打开&lt;/b&gt;&lt;br&gt;&lt;br&gt;勾选这个选项如果你希望ownKeepass在你下次打开此应用时自动打开数据库。你将被直接引导到密码查询对话框。&lt;br&gt;&lt;br&gt;</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>你可以在这里打开一个已存在的Keepass数据库文件。&lt;br&gt;&lt;br&gt;使用文件管理器来搜索你的Keepass数据库文件。你可以搜索这些地方：主目录，SD卡和安卓存储。如果你通过wonKeepass查找文件遇到问题，请确保你在下面提到的路径中查找：“主目录”通常是“%1”，如果你已经插入SD卡到手机，通常会在“/media/sdcard/&lt;UUID&gt;”。（请注意超过一个分区的SD卡是不支持的。）“安卓存储”通常在“%2”。&lt;br&gt;&lt;br&gt;建议：如果你上传Keepass数据库到云服务，请确保你和主密码一起使用了一个本地存储的关键字文件。这个关键字文件不应该上传到云服务。&lt;br&gt;&lt;br&gt;&lt;b&gt;使用关键字文件&lt;/b&gt;&lt;br&gt;&lt;br&gt;如果你需要一个关键字文件打开Keepass数据库，请检查这个选项。下面的这两个选项会在页面上自动触发。&lt;br&gt;&lt;br&gt;&lt;b&gt;主密码&lt;/b&gt;&lt;br&gt;&lt;br&gt;在这里输入Keepass数据库的密码。&lt;br&gt;&lt;br&gt;&lt;b&gt;自动打开&lt;/b&gt;&lt;br&gt;&lt;br&gt;开启这个选项如果你希望ownKeepass在下次启动时自动打开这个数据库。你将被直接引导到密码查询对话框。&lt;br&gt;&lt;br&gt;</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>在这个页面你可以修改ownKeepass应用的默认设置
&lt;br&gt;&lt;br&gt;&lt;b&gt;数据库&lt;/b&gt;&lt;br&gt;&lt;br&gt;修改这个将修改你正在使用的和新建的Keepass数据库的默认加密算法。加密算法可以在你创建完你的数据库后在设置中修改。&lt;br&gt;&lt;br&gt;设置新Keepass数据库的关键字转换算法的默认值。这个值控制主密码加密计算循环。调整这个值将直接影响载入时解密数据库的时间。但提高这个值可以使数据库更好地防范暴力破解。一个在安全性和可用性之前的不错权衡是调整这个值直到在你手机上打开数据库需要一秒的时间。&lt;br&gt;&lt;br&gt;&lt;b&gt;安全&lt;/b&gt;&lt;br&gt;&lt;br&gt;无活动锁定时间用来在ownKeepass转到后台时，在指定时间后自动锁定数据库。因此无活动计时器将在ownKeepass最小化到主屏幕封面状态后继续计时。&lt;br&gt;&lt;br&gt;快速解锁允许你在使用强主密码时依然能快速进入数据库。当你第一次打开密码安全时你需要数据完整的密码。但在随后的锁定中，你可以通过主密码的最后三位进行快速解锁。注意，如果输入错误3次，数据库将被关闭，你需要再次输入完整的主密码。&lt;br&gt;&lt;br&gt;你可以开启在复制用户名和密码后10秒清空剪贴板。&lt;br&gt;&lt;br&gt;&lt;b&gt;界面设置&lt;/b&gt;&lt;br&gt;&lt;br&gt;如果你希望在列表中显示所有密码词条的用户名和密码，请开启“扩展的列表视图”。&lt;br&gt;&lt;br&gt;开启“聚焦搜索栏”，将在你打开Keepass数据库时自动聚焦到主密码组页面的搜索栏，并显示屏幕键盘。这将使你通过搜索功能更快地寻找你想要的密码。&lt;br&gt;&lt;br&gt;&lt;b&gt;封面设置&lt;/b&gt;&lt;br&gt;&lt;br&gt;这里你可以调整封面页面的功能和显示的信息。你可以开启在封面上明文显示当前打开词条的用户名和密码。同时，你也可以开启或关闭两个封面动作。第一个动作是锁定数据库。第二个触发器用来复制用户名和密码到剪贴板或者清空剪贴板内容。&lt;br&gt;&lt;br&gt;&lt;b&gt;高级设置&lt;/b&gt;&lt;br&gt;&lt;br&gt;“专家用户模式”允许你开启一些数据库处理的高级模式。如果noi开启这个选项你可以打开不同的Keepass数据库并在主页面看到和快速进入至少五个打开的Keepass数据库。&lt;br&gt;&lt;br&gt;</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>使用主密码最后三位解锁你的“密码安全”：</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>剩余1次尝试机会</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>修改Keepass数据库文件将被存储的位置</translation>
    </message>
    <message>

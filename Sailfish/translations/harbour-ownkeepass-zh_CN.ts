...
<context>
    ...
    <message>
        ...
        <translation type="vanished">ownKeepass是一个与Keepass 1.x兼容的密码安全应用</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;b&gt;开发组&lt;/b&gt;&lt;br&gt;&lt;br&gt;Jolla（在诺基亚停止后继续开发）&lt;br&gt;KeepassX项目（Keepass的Qt实现）&lt;br&gt;所有译者: %1&lt;br&gt;&lt;br&gt;&lt;br&gt;&lt;a href=&quot;https://github.com/jobe-m/ownkeepass&quot;&gt;https://github.com/jobe-m/ownkeepass&lt;/a&gt;&lt;br&gt;&lt;br&gt;希望你在使用ownKeepass时跟我在创造它时一样快乐！</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>用户名已复制到剪贴板</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>剪贴板目前为空</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>没有打开的数据库</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>新建密码词条：</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>设置标题（强制）</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">创建新Keepass数据库的默认加密方式：</translation>
    </message>
    <message>
        <source>Default encryption:</source>
        <translation type="vanished">默认加密方式：</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>在本页上你可以创建一个新数据库，以让ownKeepass存储你的敏感数据。&lt;br&gt;&lt;br&gt;打开文件浏览器并选择一个文件名和目录。你可以选择将你的数据库存储在设备存储、SD卡或者安卓存储中。如果SD卡选项为灰色，说明没有SD卡或者SD卡被系统保护。SD卡只能有一个分区。目前ownKeepass不支持多分区SD卡。“安卓存储”用来和安卓应用共享数据库。但是，因为所有者和权限不同，和安卓共享文件可能会出现问题，请注意这点。&lt;br&gt;&lt;br&gt;建议：如果你将Keepass数据库上传到云中，请确认除了主密码外你使用的是一个本地存储的关键字文件。这个关键字文件不应该被上传到云服务中。&lt;br&gt;&lt;br&gt;&lt;b&gt;使用关键字文件&lt;/b&gt;&lt;br&gt;&lt;br&gt;一个关键字文件可以被用来存储主密码以保护Keepass数据库。两者都被一起用来生成通行金钥以打开数据库。因此，通过使用一个含有大量生成的通行金匙可以在原则上更强大地防范攻击。你可以使用例如一个随机的图片文件来作为关键字文件。&lt;br&gt;&lt;br&gt;&lt;b&gt;主密码&lt;/b&gt;&lt;br&gt;&lt;br&gt;这是你新Keepass数据库的密码。请确保你使用了大约10-15字符的长密码并混合了小写、大写、数字和特殊符号。在“确认密码”输入框中再次输入密码。&lt;br&gt;&lt;br&gt;</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>在这个对话框中你可以修改目前打开的Keepass数据库文件的内部设置。&lt;br&gt;&lt;br&gt;&lt;b&gt;主密码&lt;/b&gt;&lt;br&gt;&lt;br&gt;你可以在这里为Keepass数据库输入新的主密码。请注意如果你忘了自己的主密码，你将无法恢复你的密码。它没有保存在Keepass数据库中，也没有可以绕过主密码打开数据库的后门。另外，确保你使用了10-15字符的长密码，包含大小写、数字和特殊符号。在“确认主密码”中再次输入。&lt;br&gt;&lt;br&gt;&lt;b&gt;当前使用的加密方式&lt;/b&gt;&lt;br&gt;&lt;br&gt;这是用来计算Keepass数据库内容的加密算法。&lt;br&gt;&lt;br&gt;&lt;b&gt;关键字转换算法&lt;/b&gt;&lt;br&gt;&lt;br&gt;设置Keepass数据库关键字转换算法默认值。这个值控制主密码加密循环计算。调整这个值会直接影响载入时解密数据库所需要的时间。但提高这个值可以更好地防范暴力破解攻击。在安全和可用性权衡中，你应该调整这个值到在手机上打开数据库需要一秒钟的时间。&lt;br&gt;&lt;br&gt;</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation type="vanished">ownKeepass是一个用来存储敏感信息的安全应用，如网页密码、信用卡密码、PIN码、TAN码和其它应该保密的信息。所有信息都经过加密并本地存储在手机上。打开数据库需要你的数据库主密码。使用的数据库格式与Keepass第一版兼容。这意味着你也可以在电脑系统上解密和打开 Keepass [1]的数据库文件。&lt;br&gt;&lt;br&gt;请注意目前wonKeepass无法载入和存储Keepass第二版的数据库。这将在将来的Keepass版本中支持。&lt;br&gt;&lt;br&gt;&lt;b&gt;帮助页面的使用&lt;/b&gt;&lt;br&gt;&lt;br&gt;ownKeepass的每个页面都有自己的帮助内容。所以请使用并了解ownKeepass所提供特性，尤其是设置页面。&lt;br&gt;&lt;br&gt;&lt;b&gt;关于Keepass数据库安全&lt;/b&gt;&lt;br&gt;&lt;br&gt;ownKeepass的数据库代码基于 KeepassX项目 [2]，因此拥有大量安全相关的特色。它使用已经得到证实的算法像高级加密标准（AES/Rijndael）或者128字节块大小和256关键字大小的Twofish，SHA-256作为哈希算法和内存中加密所有密码。因此它能为主密码提供防范暴力破解和通过在解密Keepass数据库前根据哈希和加密的字典攻击的能力。这个特性称为关键字转换算法，并可以在数据库设置中修改。无论如何这些都只是在两点上增加了安全性，你需要注意：&lt;br&gt;（1）总是使用长并且难以猜测的主密码。&lt;br&gt;（2）保护你的系统免遭间谍软件的侵害，这类软件可能专门设计用来攻击wonKeepass。第二点是 安全管理10大永恒定律 [3]之#1：“如果一个坏蛋能劝说你在你的电脑上运行他的程序，这台电脑就不再是你的电脑了。”&lt;br&gt;&lt;br&gt;&lt;b&gt;在Jolla手机和电脑间共享Keepass数据库&lt;/b&gt;&lt;br&gt;&lt;br&gt;Keepass可以完美地在你的各种系统如电话、平板、桌面电脑间共享你的密码。这是因为这些平台上都有大量Keepass实现。查看 Keepass下载页面 [4]获取Keepass桌面系统的经典版本一。那个页面也有许多可选的Keepass实现。我希望指出，KeepassX版本 0.4.3 [2] 与Keepass版本一也兼容。&lt;br&gt;你可以通过SD卡或者Dropbox一类的云服务来共享你的Keepass数据库文件。当使用云服务时，我建议你除了主密码之外，同时使用一个关键字文件。这个额外的文件可以被ownKeepass用来解密数据库。仅将这个文件本地存储在你的手机和电脑中。不要将其上传到云服务。如果一个攻击者黑了你的云服务他将无法获得这个关键字文件。因为关键字文件几乎无法猜测出来，因此这样可以使攻击者更加难以攻击和破解你的Keepass数据库。&lt;br&gt;&lt;br&gt;&lt;b&gt;ownKeepass将来的版本将会添加什么&lt;/b&gt;&lt;br&gt;&lt;br&gt;无不想把这个写死，但这里有一份你可能在将来版本的ownKeepass中看到的特性列表：&lt;br&gt;&lt;ul&gt;&lt;li&gt;内建WebDAV服务的数据库同步服务如ownCloud&lt;/li&gt;&lt;li&gt;如果可能，自动在网页中输入用户名和密码&lt;/li&gt;&lt;li&gt;支持Keepass版本二的数据库文件&lt;/li&gt;&lt;/ul&gt;&lt;br&gt;&lt;br&gt;[1] &lt;a href=&quot;http://www.keepass.info&quot;&gt;www.keepass.info&lt;/a&gt;&lt;br&gt;[2] &lt;a href=&quot;www.keepassx.org&quot;&gt;www.keepassX.org&lt;/a&gt;&lt;br&gt;[3] &lt;a href=&quot;http://technet.microsoft.com/en-us/library/cc722487.aspx&quot;&gt;10 Immutable Laws of Security&lt;/a&gt;&lt;br&gt;[4] &lt;a href=&quot;http://www.keepass.info/download.html&quot;&gt;www.keepass.info/download.html&lt;/a&gt;&lt;br&gt;&lt;br&gt;</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>这个页面展示了你Keepass数据库的主要密码组。密码组是密码词条的容器。因此你需要先创建至少一个组来存储密码词条。&lt;br&gt;&lt;br&gt;你可以使用主密码组来管理你的密码词条。例如创建“在线商店”组、“电邮账户”组、“社交媒体”组等。&lt;br&gt;&lt;br&gt;可以在下拉菜单中启用搜索栏，它将显示在密码组列表顶上。你可以通过它在整个Keepass数据库中搜索密码词条。如果你希望搜索栏在打开Keepass数据库时自动获取焦点，请打开设置页面并开启相应选项。&lt;br&gt;&lt;br&gt;</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>你可以在这里打开一个已存在的Keepass数据库文件。&lt;br&gt;&lt;br&gt;使用文件管理器来搜索你的Keepass数据库文件。你可以搜索这些地方：设备存储，SD卡和安卓存储。如果你通过wonKeepass查找文件遇到问题，请确保你将文件放在了以下的路径：“设备存储”在“%1”，如果你已经插入SD卡到手机，通常会在“/media/sdcard/&lt;UUID&gt;”。（请注意超过一个分区的SD卡是不支持的。）“安卓存储”通常在“%2”。&lt;br&gt;&lt;br&gt;建议：如果你上传Keepass数据库到云服务，请确保你和主密码一起使用了一个本地存储的关键字文件。这个关键字文件不应该上传到云服务。&lt;br&gt;&lt;br&gt;&lt;b&gt;使用关键字文件&lt;/b&gt;&lt;br&gt;&lt;br&gt;如果你需要一个关键字文件打开Keepass数据库，请检查这个选项&lt;br&gt;&lt;br&gt;&lt;b&gt;主密码&lt;/b&gt;&lt;br&gt;&lt;br&gt;在这里输入Keepass数据库的密码。&lt;br&gt;&lt;br&gt;</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>在这里输入密码以打开数据库。如果你选择了关键字文件，它将从你指定的路径中自动载入。如果打开数据库错误，而你确定你提供的密码是正确的，请检查自上次成功打开数据库时，关键字文件是否还在原来的位置。
&lt;br&gt;&lt;br&gt;&lt;b&gt;自动打开&lt;/b&gt;&lt;br&gt;&lt;br&gt;启用这个选项如果你希望ownKeepass在下次启动时自动打开密码查询对话框。&lt;br&gt;&lt;br&gt;</translation>
    </message>
</context>
<context>
    <name>HelpPage</name>
...
<context>
    ...
    <message>
        ...
        <translation>这个页面展示了你Keepass数据库的密码词条和子组。密码词条最终将安全地在数据库中存储字节信息。&lt;br&gt;&lt;br&gt;可以让各个密码词条在列表中直接显示用户名和密码。开启这个特性请打开wonKeepass设置页面并开启“扩展列表视图”开关。&lt;br&gt;&lt;br&gt;搜索栏可以在下拉菜单中开启，它将显示在密码组列表顶端。通过它你可以仅在指定的密码组和其子组中搜索。&lt;br&gt;&lt;br&gt;</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>使用主密码前3位解锁你的“密码安全”：</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>新版本%1已经安装到你的手机。你可以在修改日志中查看详细信息。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>最近使用过的数据库</translation>
    </message>
    <message>
        ...
        <translation>新数据库路径和名称</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">数据库已成功关闭。没什么严重的问题，但请提交一个BUG报告。</translation>
    </message>
    <message>
        <location filename="../qml/content/MainPage.qml" line="745"/>

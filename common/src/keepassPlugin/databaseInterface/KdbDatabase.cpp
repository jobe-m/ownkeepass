    ...
    m_readOnly(false)
{
    ...
    Q_ASSERT(connect(DatabaseClient::getInstance()->getInterface(), SIGNAL(databaseOpened()),
    ...
    Q_ASSERT(connect(DatabaseClient::getInstance()->getInterface(), SIGNAL(newDatabaseCreated()),
    ...
    Q_ASSERT(connect(DatabaseClient::getInstance()->getInterface(), SIGNAL(databaseClosed()),
    ...
    Q_ASSERT(connect(this, SIGNAL(setting_sortAlphabeticallyInListView(bool)),
                     DatabaseClient::getInstance()->getInterface(), SLOT(slot_setting_sortAlphabeticallyInListView(bool))));
    Q_ASSERT(connect(this, SIGNAL(changeDatabasePassword(QString,QString)),
                  DatabaseClient::getInstance()->getInterface(), SLOT(slot_changePassKey(QString,QString))));
    Q_ASSERT(connect(DatabaseClient::getInstance()->getInterface(), SIGNAL(passwordChanged()),
    ...
    Q_ASSERT(connect(DatabaseClient::getInstance()->getInterface(), SIGNAL(databaseKeyTransfRoundsChanged(int)),
    ...
    Q_ASSERT(connect(DatabaseClient::getInstance()->getInterface(), SIGNAL(databaseCryptAlgorithmChanged(int)),
                     this, SLOT(slot_databaseCryptAlgorithmChanged(int))));
    Q_ASSERT(connect(DatabaseClient::getInstance()->getInterface(), SIGNAL(errorOccured(int,QString)),
